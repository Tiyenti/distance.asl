...
state("distance")
{
    byte playerFinished : "mono.dll", 0x001F62CC, 0x50, 0x3E4, 0x0, 0x18, 0x10, 0xC, 0x8, 0x10, 0x8, 0x6D;
    string255 richPresence : "discord-rpc.dll", 0xD51C;
    int gameState : "mono.dll", 0x001F62CC, 0x50, 0x3E4, 0x0, 0x18, 0x44;
    string255 confirmDialog : "mono.dll", 0x001F62C8, 0x0, 0x50, 0x3E0, 0x0, 0x18, 0x20, 0x80, 0x28, 0x10, 0x11c, 0xC; // TODO: find a new pointer path for this
